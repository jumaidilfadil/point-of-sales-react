...
class Register extends Component {
  ...
  registerResult = () => {
    ...
    else if(this.state.message === 'Username already exist.' || this.state.message === 'Register failed.')
    {
      return (
  ...
  render() {
    return (
      <section class="fdb-block py-0">
        <div class="container py-5 my-5" style={{backgroundImage: `url(${backgroundImage})`}}>
          <div class="row">
            <div class="col-12 col-md-8 col-lg-7 col-xl-5 text-left fdb-box">
              ...
              <p className="mt-4 small">
                Already have an account? <Link className='btn btn-link pl-1 text-capitalize' to='/' exact>Login here.</Link>
              </p>
              {this.registerResult()}
            </div>
          </div>
